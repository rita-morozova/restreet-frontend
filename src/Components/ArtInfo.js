      ...
      <div className="modal-art-info">
        <div className="inner-modal-art">
          <div className="buttons">
            <Button.Group>
              <Button onClick={goBackToAllArts} color="yellow">
                Back
              </Button>
              <Button.Or />
              <Button onClick={() => addToFavorites(chosenArt)} color="red">
                {" "}
                <Icon color="yellow" name="heart" size="large" />
              </Button>
            </Button.Group>
          </div>
          <div className="art-page">
            ...
            <div className="art-info">
              ...
              <h3 style={{ fontStyle: "italic" }}>
                {chosenArt.year === 0 ? "Unknown Year" : chosenArt.year}
              </h3>
            </div>
          </div>
        </div>
