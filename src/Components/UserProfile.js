              ...
              <div className="row coralbg white">
                <div className="col-md-6 no-pad">
                  <div className="user-pad">
                    <h1>
                      Welcome back,{" "}
                      {this.props.user.name ? this.props.user.name : "Stranger"}
                    </h1>
                    <h3 className="white">
              ...
              <div className="row overview">
                <div className="col-md-4 user-pad text-center coralbg">
                  <Link to="/my-inspiration">
                    <h3 style={{ color: "white" }}>FAVORITE ART</h3>
                  </Link>
                </div>
                <div className="col-md-4 user-pad text-center turqbg">
                  <Link to="/my-library">
                    <h3 style={{ color: "white" }}>MY LIBRARY</h3>
                  </Link>
                </div>
                <div className="col-md-4 user-pad text-center coralbg">
                  <Link to="/my-listings">
                    <h3 style={{ color: "white" }}>MY LISTINGS</h3>
                  </Link>
                </div>
              </div>
            </div>
